      ...
      <div className="relative mx-auto flex h-16 max-w-[1920px] items-center justify-between px-4 sm:px-5 pt-[42px] 2xl:px-8">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <div className="flex items-center">
            ...
            <button className="relative mx-1 bg-[#AD1AAF] text-white px-4 xl:px-6 py-3 text-base xl:text-lg font-medium 
              transition-all duration-300 hover:bg-[#8c158e] hover:shadow-lg hover:scale-105 h-[55px]">
              <div className="first-bar" />
              <span className="relative z-10 font-oxanium whitespace-nowrap">Connect Wallet</span>
...
>
  <div className="flex flex-col items-start p-6 gap-6">
    ...
    <button className="w-full bg-[#AD1AAF] text-white px-6 py-3 text-base font-medium 
