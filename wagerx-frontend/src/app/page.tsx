    ...
    <Layout>
        ...
        ${
          isLoaded
            ...
            >
              ...
              ,{" "}
              <span
                className="inline-block text-[#F81DFB] transition-transform duration-300"
      ...
      ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
          ...
          hover:scale-105 transform-gpu "
              >
                <div
                  className="absolute inset-0 bg-gradient-to-r from-[#AD1AAF] to-[#8c158e] opacity-0 
          ...
          bg-[radial-gradient(circle_at_50%_50%,rgba(248,29,251,0.5),transparent_60%)]"
                ...
                <span
                  className="relative z-10 font-oxanium transition-transform duration-500
        ...
        ${
          isLoaded
            ...
            : "translate-y-8 opacity-0 scale-95"
              ...
              style={{ transitionDelay: "200ms" }}
            >
              Bet on life’s fun moments with friends! Our social prediction
              market lets you create or join bets on
              <span className="inline-block text-[#F81DFB] font-semibold transition-transform duration-300">
                sports outcomes
              </span>
              ,{" "}
              <span
                className="inline-block text-[#F81DFB] font-semibold transition-transform duration-300"
                style={{ animationDelay: "0.2s" }}
              >
                anything—fitness goals{" "}
              </span>
              , or{" "}
              <span
                className="inline-block text-[#F81DFB] font-semibold transition-transform duration-300"
              ...
              Compete, track progress, and win rewards—all powered by Web3. No
              complex odds, just friendly wagers with real stakes!
            </p>
            <div className="mt-16">
              ...
              transition-all duration-500 hover:scale-110"
                  ...
                  >
                    ...
                    <div
                      className="rounded-full bg-white/10 p-4 transition-all duration-500 
              group-hover:bg-white/20 group-hover:shadow-[0_0_30px_rgba(173,26,175,0.5)]
              transform group-hover:-translate-y-2"
                    >
                      <item.icon
                        className="h-[40px] w-[40px] sm:h-[50px] sm:w-[50px] text-[#AD1AAF]
                transition-all duration-500 group-hover:scale-110 group-hover:rotate-[360deg]"
                    ...
                    <div
                      className="relative mt-4 text-center transition-all duration-500 
              group-hover:-translate-y-2"
                    >
                      <span
                        className="block text-md sm:text-lg font-oxanium text-white 
                transition-all duration-500 group-hover:text-[#F81DFB]"
                      ...
                      {/* Description tooltip */}
                      <span
                        className="absolute top-full left-1/2 -translate-x-1/2 w-48 mt-2 
              ...
              transition-opacity duration-500 pointer-events-none"
                ...
                <div className="absolute top-10 left-0 right-0 hidden sm:block overflow-hidden">
                  <div
                    className="h-0.5 bg-gradient-to-r from-transparent via-[#AD1AAF]/50 to-transparent
